...
void ORC_ProxyData::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("get_flags_mask"), &ORC_ProxyData::get_flags_mask);
...
bool ORC_ProxyData::set_flag(const StringName& flag_name, bool value) {
    ...
    return registry->set_flag_internal(this, flag_name, value, false);
}
...
int64_t ORC_ProxyData::get_flags_mask() const {
    DEV_ASSERT(registry != nullptr && "No registry associated with this ProxyData.");
    return registry->get_flags_mask_internal(const_cast<ORC_ProxyData*>(this));
}
