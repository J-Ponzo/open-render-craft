...
public:
	...
	Dictionary get_render_passes() { return render_passes; }
	void set_render_passes(Dictionary render_passes) { this->render_passes = render_passes; }

	// TODO : would be greate to type this. But could not manage to make it work so far
	Dictionary attachments;
	Dictionary get_attachments() { return attachments; }
	void set_attachments(Dictionary attachments) { this->attachments = attachments; }
